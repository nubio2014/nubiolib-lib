...
import com.mlzq.nubiolib.app.MyApplication;
...
//		Logger.addLogAdapter(new AndroidLogAdapter(formatStrategy));
    ...
    public static void e(String str) {
        if (MyApplication.isLog) Logger.e(str);
    }

    //调用 Logger.t("临时TAG名").d()
    public static void e(String tag, String msg) {
        if (MyApplication.isLog) Logger.t(tag).d(msg);
    }

    public static void d(String str) {
        if (MyApplication.isLog) Logger.d(str);
    }

    public static void xml(String str) {
        if (MyApplication.isLog) Logger.xml(str);
    }
}
