...
public class PickerScrollViewmin extends View {
    ...
    public PickerScrollViewmin(Context context) {
        super(context);
        init();
    }

    public PickerScrollViewmin(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     * 给选择的项添加后缀文字
     */
    private String SELECTED_SUFFIX_CHARACTER = "";

    public void setSELECTED_SUFFIX_CHARACTER(String sel) {
        SELECTED_SUFFIX_CHARACTER = sel;
    }
    private void drawData(Canvas canvas) {
        ...
        canvas.drawText(textData+ SELECTED_SUFFIX_CHARACTER, x, baseline, mPaint);
