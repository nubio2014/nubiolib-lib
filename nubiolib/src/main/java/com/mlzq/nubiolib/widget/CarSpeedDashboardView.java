...
public class CarSpeedDashboardView extends View {
    ...
    private String mHeaderText = "kW.h"; // 表头
    ...
    private int[] mColors;
    public String propertyName="mRealTimeValue"; // 指针短半径
    public CarSpeedDashboardView(Context context) {
        this(context, null);
    }

    public CarSpeedDashboardView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CarSpeedDashboardView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
      ...
      //  Log.e(TAG, "onMeasure: width:"+width+"     height:"+height + getPaddingTop() + getPaddingBottom() );

      //  setMeasuredDimension(width, (height + getPaddingTop() + getPaddingBottom())/2);
  ...
  //  private static final String TAG = "DashboardView4";
    @Override
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);

        canvas.drawColor(ContextCompat.getColor(getContext(), R.color.tran));//背景颜色
        /**
         * 画圆弧
         */
      ...
      //  Log.e(TAG, "onDraw: "+mRectFArc );
        ...
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.red_text));
     ...
     * @param number
     */
    public void setCarSpeedDashboardViewNum(int number){
    if (isAnimFinished) {
        ObjectAnimator animator = ObjectAnimator.ofInt(this, propertyName,
                getVelocity(),number );
